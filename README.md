# GeoKit [![CI](https://github.com/andrewscwei/swift-geokit/workflows/CI/badge.svg?branch=master)](https://github.com/andrewscwei/swift-geokit/actions/workflows/ci.yml?query=branch%3Amain)
